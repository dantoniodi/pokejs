...
function calcDmg(move,ata,rec,crit,tmod) {
  ...
  let Y = tmod //type modifiers (4, 2, 1, 0.5, 0.25 or 0)
  ...
  let stab = ata.type.name
  console.log('STAB: '+stab.includes(move.type)+', TE:'+Y);
  ...
  let finalDmg = totalDmg > rec.hp.now ? rec.hp.now : totalDmg //prevents overkill
